"""FastAPI application factory for the rosette API server."""
...
from rosette.db.session import init_async_db, init_db
...
def create_app(config: RosetteConfig | None = None) -> FastAPI:
    """Create and configure the FastAPI application.

    Args:
        config: Optional RosetteConfig instance. If not provided, default
    ...
    # Include routes
    from rosette.api.routes import router
