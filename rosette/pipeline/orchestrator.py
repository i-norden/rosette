...
from rosette.analysis.llm_vision import analyze_figure_detailed, classify_figure, screen_figure
...
from rosette.extraction.pdf_parser import download_pdf, extract_text
from rosette.extraction.stats_extractor import extract_means_and_ns, extract_test_statistics
from rosette.extraction.table_extractor import extract_tables
from rosette.llm.claude import ClaudeProvider
from rosette.pipeline.stages import PIPELINE_STAGES, _LEGACY_STAGE_MAP
from rosette.reporting.proof import generate_html_report, generate_markdown_report
...
class PipelineOrchestrator:
    ...
    def __init__(self, config: RosetteConfig):
        self.config = config
    ...
    async def _run_report(self, paper_id: str) -> None:
        ...
        async with get_async_session() as session:
            ...
            if evidence.paper_risk != "clean" and finding_dicts:
                try:
                    from rosette.llm.prompts import PROMPT_SUMMARIZE_EVIDENCE, SYSTEM_PROOF_WRITER
