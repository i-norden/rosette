...
def create(
    ...
    from rosette.db.models import Campaign
    ...
    click.echo(f"\nRun with: rosette campaign run {campaign_id}")
...
def export_campaign(
    ...
    from rosette.db.models import Campaign, CampaignPaper, Paper, Report
...
def _print_campaign_detail(session, c) -> None:  # type: ignore[no-untyped-def]
    ...
    from rosette.db.models import CampaignPaper
