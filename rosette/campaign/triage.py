...
from rosette.db.models import Campaign, CampaignPaper, Figure, Finding, Paper
...
class TriagePipeline:
    ...
    def __init__(self, config: RosetteConfig, campaign_id: str):
        self.config = config
    ...
    async def _compute_auto_risk_score(self, paper_id: str) -> float:
        ...
        async with get_async_session() as session:
            ...
            from rosette.db.models import ImageHashMatch
    ...
    async def _check_external_signals(self, paper_id: str) -> None:
        ...
        async with get_async_session() as session:
            ...
            if paper.retraction_status is None:
                try:
                    from rosette.discovery.retraction_watch import check_retraction_status
