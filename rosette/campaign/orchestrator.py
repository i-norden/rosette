...
from rosette.campaign.hash_scanner import CampaignHashScanner
from rosette.campaign.triage import TriagePipeline
...
class CampaignOrchestrator:
    ...
    async def _run_author_network_analysis(self) -> None:
        ...
        try:
            from rosette.analysis.author_network import run_network_analysis
