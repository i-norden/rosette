"""Download and generate test fixtures for snoopy integration tests and demos.
...
from snoopy.reporting.pretty import console, create_progress

logger = logging.getLogger(__name__)

# Resolve project root relative to this file: snoopy/demo/fixtures.py -> project root
...
def download_all() -> dict[str, int]:
    ...
    with httpx.Client(
        headers={"User-Agent": "snoopy-test-fixtures/0.1 (academic research tool)"},
